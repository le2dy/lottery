...
category = ['Ones', 'Twos', 'Threes', 'Fours', 'Fives', 'Sixes', 'Choice', '4 of a Kind', 'Full House',
            'Small Straight', 'Big Straight', 'Yacht']
...
def end_of_game():
    ...
    if p1 > p2:
        ...
        winner = names[1]
    comments = ['The game is finished.', "Let's check the final score.", 'Final score is...', str(p1) + ":" + str(p2),
                "Winner is " + winner + "!", "Congratulation!"]
